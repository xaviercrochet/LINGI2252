...
The whole point of object oriented programming is to design softwares that are easy to modify and extend. In order to achieve this, we have to find bad smells and apply object oriented pattern to eliminate these issues. We don't have the place here to look over everything. Insted, we'll focus our analysis on two important matters. We start by cheking how well accessor are used in the system. Then, how the concept of object is use to avoir long parameter list. 
