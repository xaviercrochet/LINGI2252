...
(browser transmit)
	...
	from: #two;
\end{lstlisting}
This duplication class is related to a test class named \textit{GLMUpdateInterdepententPanesTest}. We can extract a new class here and use it in the test class.
